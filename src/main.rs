...
fn main() {
  ...
  board.state[0][4] = board::Square::Black;
  println!("{}{}", board, board.check_aligned(0, 4, &board::Square::Black));
  ...
  println!("{}{}", board, board.check_aligned(4, 0, &board::Square::Black));
  ...
  println!("{}{}", board, board.check_aligned(18, 14, &board::Square::Black));
  board = board::Board::new();
  ...
  println!("{}{}", board, board.check_aligned(4, 18, &board::Square::Black));
  board = board::Board::new();
  ...
  println!("{}{}", board, board.check_aligned(18, 4, &board::Square::Black));
}
